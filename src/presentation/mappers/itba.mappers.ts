...
export class ItbaMappers {
    ...
    static careerMapToDto(careerMap: Record<string, Career>): Record<string, CareerDto> {
    ...
    static classroomScheduleToScheduleDto(schedule: ClassroomSchedule): ClassroomScheduleDto {
        return {
    ...
    static groupClassroomsByBuilding(classrooms: ClassroomSchedule[]): ClassroomsByBuildingDto {
    ...
    static groupClassroomsByDayAndBuilding(classrooms: ClassroomSchedule[]): ClassroomsByDayAndBuildingDto {
    ...
    static classroomSchedulesToDto(schedules: ClassroomSchedule[]): ClassroomDto[] {
        return schedules.map(this.classroomScheduleToDto);
    }

    static classroomSchedulesToScheduleDto(schedules: ClassroomSchedule[]): ClassroomScheduleDto[] {
